...
var separator = " ";
var count = 0;
//Get all 4 word usernames.
for (var temp4 = 0; temp4 < 33; temp4++) {
    for (var temp = temp4 + 1; temp < 34; temp++) {
        for (var temp2 = temp + 1; temp2 < 35; temp2++) {
            for (var temp3 = temp2 + 1; temp3 < 36; temp3++) {
                count++;
                usernameArr[usernameArr.length] = wordlist[temp4] + separator + wordlist[temp] + separator + wordlist[temp2] + separator + wordlist[temp3];
            }
        }
    }
}
